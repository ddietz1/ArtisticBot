...
enum
{
  interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__request__MAX_SIZE = 1
};
// response
enum
{
  interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/MoveItPlan in the package interbotix_moveit_interface_msgs.
typedef struct interbotix_moveit_interface_msgs__srv__MoveItPlan_Event
{
  service_msgs__msg__ServiceEventInfo info;
  interbotix_moveit_interface_msgs__srv__MoveItPlan_Request__Sequence request;
  interbotix_moveit_interface_msgs__srv__MoveItPlan_Response__Sequence response;
} interbotix_moveit_interface_msgs__srv__MoveItPlan_Event;

// Struct for a sequence of interbotix_moveit_interface_msgs__srv__MoveItPlan_Event.
typedef struct interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence
{
