...
class Init_MoveItPlan_Event_response
{
public:
  explicit Init_MoveItPlan_Event_response(::interbotix_moveit_interface_msgs::srv::MoveItPlan_Event & msg)
  : msg_(msg)
  {}
  ::interbotix_moveit_interface_msgs::srv::MoveItPlan_Event response(::interbotix_moveit_interface_msgs::srv::MoveItPlan_Event::_response_type arg)
  {
...
private:
  ::interbotix_moveit_interface_msgs::srv::MoveItPlan_Event msg_;
};

class Init_MoveItPlan_Event_request
{
public:
  explicit Init_MoveItPlan_Event_request(::interbotix_moveit_interface_msgs::srv::MoveItPlan_Event & msg)
  : msg_(msg)
  {}
  Init_MoveItPlan_Event_response request(::interbotix_moveit_interface_msgs::srv::MoveItPlan_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_MoveItPlan_Event_response(msg_);
  }
...
class Init_MoveItPlan_Event_info
{
public:
  Init_MoveItPlan_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_MoveItPlan_Event_request info(::interbotix_moveit_interface_msgs::srv::MoveItPlan_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_MoveItPlan_Event_request(msg_);
  }
...
template<>
inline
auto build<::interbotix_moveit_interface_msgs::srv::MoveItPlan_Event>()
{
  return interbotix_moveit_interface_msgs::srv::builder::Init_MoveItPlan_Event_info();
}
