...
static const _MoveItPlan_Event_type_support_symbol_names_t _MoveItPlan_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interbotix_moveit_interface_msgs, srv, MoveItPlan_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_moveit_interface_msgs, srv, MoveItPlan_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interbotix_moveit_interface_msgs, srv, MoveItPlan_Event)() {
  return &::interbotix_moveit_interface_msgs::srv::rosidl_typesupport_c::MoveItPlan_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t MoveItPlan_service_type_support_handle = {
  ...
  &MoveItPlan_Request_message_type_support_handle,
  &MoveItPlan_Response_message_type_support_handle,
  &MoveItPlan_Event_message_type_support_handle,
