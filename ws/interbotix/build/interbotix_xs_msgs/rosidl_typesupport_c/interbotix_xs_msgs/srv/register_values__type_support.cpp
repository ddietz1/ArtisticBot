...
static const _RegisterValues_Event_type_support_symbol_names_t _RegisterValues_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interbotix_xs_msgs, srv, RegisterValues_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_xs_msgs, srv, RegisterValues_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interbotix_xs_msgs, srv, RegisterValues_Event)() {
  return &::interbotix_xs_msgs::srv::rosidl_typesupport_c::RegisterValues_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t RegisterValues_service_type_support_handle = {
  ...
  &RegisterValues_Request_message_type_support_handle,
  &RegisterValues_Response_message_type_support_handle,
  &RegisterValues_Event_message_type_support_handle,
