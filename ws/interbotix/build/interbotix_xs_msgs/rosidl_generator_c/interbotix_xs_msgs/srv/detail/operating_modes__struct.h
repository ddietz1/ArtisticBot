...
// IWYU pragma: private, include "interbotix_xs_msgs/srv/operating_modes.h"
...
enum
{
  interbotix_xs_msgs__srv__OperatingModes_Event__request__MAX_SIZE = 1
};
// response
enum
{
  interbotix_xs_msgs__srv__OperatingModes_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/OperatingModes in the package interbotix_xs_msgs.
typedef struct interbotix_xs_msgs__srv__OperatingModes_Event
{
  service_msgs__msg__ServiceEventInfo info;
  interbotix_xs_msgs__srv__OperatingModes_Request__Sequence request;
  interbotix_xs_msgs__srv__OperatingModes_Response__Sequence response;
} interbotix_xs_msgs__srv__OperatingModes_Event;

// Struct for a sequence of interbotix_xs_msgs__srv__OperatingModes_Event.
typedef struct interbotix_xs_msgs__srv__OperatingModes_Event__Sequence
{
