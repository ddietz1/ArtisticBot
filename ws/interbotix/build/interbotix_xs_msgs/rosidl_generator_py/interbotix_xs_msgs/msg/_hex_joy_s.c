...
bool interbotix_xs_msgs__msg__hex_joy__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interbotix_xs_msgs.msg._hex_joy", (char *)PyUnicode_1BYTE_DATA(module_attr), 31) == 0);
    assert(strncmp("HexJoy", (char *)PyUnicode_1BYTE_DATA(name_attr), 6) == 0);
