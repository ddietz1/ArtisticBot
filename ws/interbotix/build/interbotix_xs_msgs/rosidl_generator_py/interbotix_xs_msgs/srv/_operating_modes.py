...
class Metaclass_OperatingModes_Event(type):
    """Metaclass of message 'OperatingModes_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__operating_modes__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__operating_modes__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__operating_modes__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__operating_modes__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__operating_modes__event
...
class OperatingModes_Event(metaclass=Metaclass_OperatingModes_Event):
    """Message class 'OperatingModes_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<interbotix_xs_msgs/OperatingModes_Request, 1>',
        'response': 'sequence<interbotix_xs_msgs/OperatingModes_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['interbotix_xs_msgs', 'srv'], 'OperatingModes_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['interbotix_xs_msgs', 'srv'], 'OperatingModes_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from interbotix_xs_msgs.srv import OperatingModes_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, OperatingModes_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'OperatingModes_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from interbotix_xs_msgs.srv import OperatingModes_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, OperatingModes_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'OperatingModes_Response'"
...
class Metaclass_OperatingModes(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _operating_modes.Metaclass_OperatingModes_Event._TYPE_SUPPORT is None:
                _operating_modes.Metaclass_OperatingModes_Event.__import_type_support__()
...
class OperatingModes(metaclass=Metaclass_OperatingModes):
    ...
    from interbotix_xs_msgs.srv._operating_modes import OperatingModes_Event as Event
