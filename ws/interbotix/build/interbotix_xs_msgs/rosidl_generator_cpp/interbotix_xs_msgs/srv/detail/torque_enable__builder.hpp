...
class Init_TorqueEnable_Event_response
{
public:
  explicit Init_TorqueEnable_Event_response(::interbotix_xs_msgs::srv::TorqueEnable_Event & msg)
  : msg_(msg)
  {}
  ::interbotix_xs_msgs::srv::TorqueEnable_Event response(::interbotix_xs_msgs::srv::TorqueEnable_Event::_response_type arg)
  {
...
private:
  ::interbotix_xs_msgs::srv::TorqueEnable_Event msg_;
};

class Init_TorqueEnable_Event_request
{
public:
  explicit Init_TorqueEnable_Event_request(::interbotix_xs_msgs::srv::TorqueEnable_Event & msg)
  : msg_(msg)
  {}
  Init_TorqueEnable_Event_response request(::interbotix_xs_msgs::srv::TorqueEnable_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_TorqueEnable_Event_response(msg_);
  }
...
class Init_TorqueEnable_Event_info
{
public:
  Init_TorqueEnable_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_TorqueEnable_Event_request info(::interbotix_xs_msgs::srv::TorqueEnable_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_TorqueEnable_Event_request(msg_);
  }
...
template<>
inline
auto build<::interbotix_xs_msgs::srv::TorqueEnable_Event>()
{
  return interbotix_xs_msgs::srv::builder::Init_TorqueEnable_Event_info();
}
