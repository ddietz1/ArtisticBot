...
inline void to_flow_style_yaml(
  const RegisterValues_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const RegisterValues_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use interbotix_xs_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const interbotix_xs_msgs::srv::RegisterValues_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  interbotix_xs_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use interbotix_xs_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const interbotix_xs_msgs::srv::RegisterValues_Event & msg)
{
  return interbotix_xs_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<interbotix_xs_msgs::srv::RegisterValues_Event>()
{
  return "interbotix_xs_msgs::srv::RegisterValues_Event";
}

template<>
inline const char * name<interbotix_xs_msgs::srv::RegisterValues_Event>()
{
  return "interbotix_xs_msgs/srv/RegisterValues_Event";
}

template<>
struct has_fixed_size<interbotix_xs_msgs::srv::RegisterValues_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<interbotix_xs_msgs::srv::RegisterValues_Event>
  : std::integral_constant<bool, has_bounded_size<interbotix_xs_msgs::srv::RegisterValues_Request>::value && has_bounded_size<interbotix_xs_msgs::srv::RegisterValues_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<interbotix_xs_msgs::srv::RegisterValues_Event>
  : std::true_type {};
