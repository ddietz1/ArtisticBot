...
static const _TorqueEnable_Event_type_support_symbol_names_t _TorqueEnable_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interbotix_xs_msgs, srv, TorqueEnable_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interbotix_xs_msgs, srv, TorqueEnable_Event)),
  }
};
...
{
  return &::interbotix_xs_msgs::srv::rosidl_typesupport_cpp::TorqueEnable_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interbotix_xs_msgs, srv, TorqueEnable_Event)() {
  return get_message_type_support_handle<interbotix_xs_msgs::srv::TorqueEnable_Event>();
}
...
static const rosidl_service_type_support_t TorqueEnable_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<interbotix_xs_msgs::srv::TorqueEnable_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<interbotix_xs_msgs::srv::TorqueEnable_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<interbotix_xs_msgs::srv::TorqueEnable_Event>(),
