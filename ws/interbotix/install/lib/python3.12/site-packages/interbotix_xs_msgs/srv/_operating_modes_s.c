...
bool interbotix_xs_msgs__srv__operating_modes__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interbotix_xs_msgs.srv._operating_modes", (char *)PyUnicode_1BYTE_DATA(module_attr), 39) == 0);
    assert(strncmp("OperatingModes_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 22) == 0);
...
bool interbotix_xs_msgs__srv__operating_modes__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("interbotix_xs_msgs.srv._operating_modes", (char *)PyUnicode_1BYTE_DATA(module_attr), 39) == 0);
    assert(strncmp("OperatingModes_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 23) == 0);
...
ROSIDL_GENERATOR_C_EXPORT
bool interbotix_xs_msgs__srv__operating_modes__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    PyObject * class_attr = PyObject_GetAttrString(_pymsg, "__class__");
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("interbotix_xs_msgs.srv._operating_modes", (char *)PyUnicode_1BYTE_DATA(module_attr), 39) == 0);
    assert(strncmp("OperatingModes_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 20) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  interbotix_xs_msgs__srv__OperatingModes_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!interbotix_xs_msgs__srv__OperatingModes_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create interbotix_xs_msgs__srv__OperatingModes_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    interbotix_xs_msgs__srv__OperatingModes_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!interbotix_xs_msgs__srv__operating_modes__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!interbotix_xs_msgs__srv__OperatingModes_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create interbotix_xs_msgs__srv__OperatingModes_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    interbotix_xs_msgs__srv__OperatingModes_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!interbotix_xs_msgs__srv__operating_modes__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of OperatingModes_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interbotix_xs_msgs.srv._operating_modes");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OperatingModes_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = interbotix_xs_msgs__srv__operating_modes__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = interbotix_xs_msgs__srv__operating_modes__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
