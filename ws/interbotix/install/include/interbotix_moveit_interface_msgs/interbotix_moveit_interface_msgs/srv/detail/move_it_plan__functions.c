...
interbotix_moveit_interface_msgs__srv__MoveItPlan_Request__create(void)
{
...
interbotix_moveit_interface_msgs__srv__MoveItPlan_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__init(interbotix_moveit_interface_msgs__srv__MoveItPlan_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__fini(msg);
    return false;
  }
  // request
  if (!interbotix_moveit_interface_msgs__srv__MoveItPlan_Request__Sequence__init(&msg->request, 0)) {
    interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__fini(msg);
    return false;
  }
  // response
  if (!interbotix_moveit_interface_msgs__srv__MoveItPlan_Response__Sequence__init(&msg->response, 0)) {
    interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__fini(msg);
    return false;
  }
  return true;
...
void
interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__fini(interbotix_moveit_interface_msgs__srv__MoveItPlan_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  interbotix_moveit_interface_msgs__srv__MoveItPlan_Request__Sequence__fini(&msg->request);
  // response
  interbotix_moveit_interface_msgs__srv__MoveItPlan_Response__Sequence__fini(&msg->response);
}

bool
interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__are_equal(const interbotix_moveit_interface_msgs__srv__MoveItPlan_Event * lhs, const interbotix_moveit_interface_msgs__srv__MoveItPlan_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!interbotix_moveit_interface_msgs__srv__MoveItPlan_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!interbotix_moveit_interface_msgs__srv__MoveItPlan_Response__Sequence__are_equal(
...
bool
interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__copy(
  const interbotix_moveit_interface_msgs__srv__MoveItPlan_Event * input,
  interbotix_moveit_interface_msgs__srv__MoveItPlan_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!interbotix_moveit_interface_msgs__srv__MoveItPlan_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!interbotix_moveit_interface_msgs__srv__MoveItPlan_Response__Sequence__copy(
...
interbotix_moveit_interface_msgs__srv__MoveItPlan_Event *
interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interbotix_moveit_interface_msgs__srv__MoveItPlan_Event * msg = (interbotix_moveit_interface_msgs__srv__MoveItPlan_Event *)allocator.allocate(sizeof(interbotix_moveit_interface_msgs__srv__MoveItPlan_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(interbotix_moveit_interface_msgs__srv__MoveItPlan_Event));
  bool success = interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__destroy(interbotix_moveit_interface_msgs__srv__MoveItPlan_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__fini(msg);
...
bool
interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence__init(interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interbotix_moveit_interface_msgs__srv__MoveItPlan_Event * data = NULL;

  if (size) {
    data = (interbotix_moveit_interface_msgs__srv__MoveItPlan_Event *)allocator.zero_allocate(size, sizeof(interbotix_moveit_interface_msgs__srv__MoveItPlan_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence__fini(interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence *
interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence * array = (interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence *)allocator.allocate(sizeof(interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence__destroy(interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence__are_equal(const interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence * lhs, const interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence__copy(
  const interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence * input,
  interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interbotix_moveit_interface_msgs__srv__MoveItPlan_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    interbotix_moveit_interface_msgs__srv__MoveItPlan_Event * data =
      (interbotix_moveit_interface_msgs__srv__MoveItPlan_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!interbotix_moveit_interface_msgs__srv__MoveItPlan_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
