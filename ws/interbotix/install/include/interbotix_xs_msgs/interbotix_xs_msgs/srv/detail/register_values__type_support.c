...
void interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__RegisterValues_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  interbotix_xs_msgs__srv__RegisterValues_Event__init(message_memory);
}

void interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__RegisterValues_Event_fini_function(void * message_memory)
{
  interbotix_xs_msgs__srv__RegisterValues_Event__fini(message_memory);
}

size_t interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__size_function__RegisterValues_Event__request(
  const void * untyped_member)
{
  const interbotix_xs_msgs__srv__RegisterValues_Request__Sequence * member =
    (const interbotix_xs_msgs__srv__RegisterValues_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__get_const_function__RegisterValues_Event__request(
  const void * untyped_member, size_t index)
{
  const interbotix_xs_msgs__srv__RegisterValues_Request__Sequence * member =
    (const interbotix_xs_msgs__srv__RegisterValues_Request__Sequence *)(untyped_member);
...
void * interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__get_function__RegisterValues_Event__request(
  void * untyped_member, size_t index)
{
  interbotix_xs_msgs__srv__RegisterValues_Request__Sequence * member =
    (interbotix_xs_msgs__srv__RegisterValues_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__fetch_function__RegisterValues_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const interbotix_xs_msgs__srv__RegisterValues_Request * item =
    ((const interbotix_xs_msgs__srv__RegisterValues_Request *)
    interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__get_const_function__RegisterValues_Event__request(untyped_member, index));
  interbotix_xs_msgs__srv__RegisterValues_Request * value =
    (interbotix_xs_msgs__srv__RegisterValues_Request *)(untyped_value);
  *value = *item;
}

void interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__assign_function__RegisterValues_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  interbotix_xs_msgs__srv__RegisterValues_Request * item =
    ((interbotix_xs_msgs__srv__RegisterValues_Request *)
    interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__get_function__RegisterValues_Event__request(untyped_member, index));
  const interbotix_xs_msgs__srv__RegisterValues_Request * value =
    (const interbotix_xs_msgs__srv__RegisterValues_Request *)(untyped_value);
  *item = *value;
}

bool interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__resize_function__RegisterValues_Event__request(
  void * untyped_member, size_t size)
{
  interbotix_xs_msgs__srv__RegisterValues_Request__Sequence * member =
    (interbotix_xs_msgs__srv__RegisterValues_Request__Sequence *)(untyped_member);
  interbotix_xs_msgs__srv__RegisterValues_Request__Sequence__fini(member);
  return interbotix_xs_msgs__srv__RegisterValues_Request__Sequence__init(member, size);
}

size_t interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__size_function__RegisterValues_Event__response(
  const void * untyped_member)
{
  const interbotix_xs_msgs__srv__RegisterValues_Response__Sequence * member =
    (const interbotix_xs_msgs__srv__RegisterValues_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__get_const_function__RegisterValues_Event__response(
  const void * untyped_member, size_t index)
{
  const interbotix_xs_msgs__srv__RegisterValues_Response__Sequence * member =
    (const interbotix_xs_msgs__srv__RegisterValues_Response__Sequence *)(untyped_member);
...
void * interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__get_function__RegisterValues_Event__response(
  void * untyped_member, size_t index)
{
  interbotix_xs_msgs__srv__RegisterValues_Response__Sequence * member =
    (interbotix_xs_msgs__srv__RegisterValues_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__fetch_function__RegisterValues_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const interbotix_xs_msgs__srv__RegisterValues_Response * item =
    ((const interbotix_xs_msgs__srv__RegisterValues_Response *)
    interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__get_const_function__RegisterValues_Event__response(untyped_member, index));
  interbotix_xs_msgs__srv__RegisterValues_Response * value =
    (interbotix_xs_msgs__srv__RegisterValues_Response *)(untyped_value);
  *value = *item;
}

void interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__assign_function__RegisterValues_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  interbotix_xs_msgs__srv__RegisterValues_Response * item =
    ((interbotix_xs_msgs__srv__RegisterValues_Response *)
    interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__get_function__RegisterValues_Event__response(untyped_member, index));
  const interbotix_xs_msgs__srv__RegisterValues_Response * value =
    (const interbotix_xs_msgs__srv__RegisterValues_Response *)(untyped_value);
  *item = *value;
}

bool interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__resize_function__RegisterValues_Event__response(
  void * untyped_member, size_t size)
{
  interbotix_xs_msgs__srv__RegisterValues_Response__Sequence * member =
    (interbotix_xs_msgs__srv__RegisterValues_Response__Sequence *)(untyped_member);
  interbotix_xs_msgs__srv__RegisterValues_Response__Sequence__fini(member);
  return interbotix_xs_msgs__srv__RegisterValues_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__RegisterValues_Event_message_member_array[3] = {
  {
    "info",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interbotix_xs_msgs__srv__RegisterValues_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(interbotix_xs_msgs__srv__RegisterValues_Event, request),  // bytes offset in struct
    NULL,  // default value
    interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__size_function__RegisterValues_Event__request,  // size() function pointer
    interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__get_const_function__RegisterValues_Event__request,  // get_const(index) function pointer
    interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__get_function__RegisterValues_Event__request,  // get(index) function pointer
    interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__fetch_function__RegisterValues_Event__request,  // fetch(index, &value) function pointer
    interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__assign_function__RegisterValues_Event__request,  // assign(index, value) function pointer
    interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__resize_function__RegisterValues_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(interbotix_xs_msgs__srv__RegisterValues_Event, response),  // bytes offset in struct
    NULL,  // default value
    interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__size_function__RegisterValues_Event__response,  // size() function pointer
    interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__get_const_function__RegisterValues_Event__response,  // get_const(index) function pointer
    interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__get_function__RegisterValues_Event__response,  // get(index) function pointer
    interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__fetch_function__RegisterValues_Event__response,  // fetch(index, &value) function pointer
    interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__assign_function__RegisterValues_Event__response,  // assign(index, value) function pointer
    interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__resize_function__RegisterValues_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__RegisterValues_Event_message_members = {
  "interbotix_xs_msgs__srv",  // message namespace
  "RegisterValues_Event",  // message name
  3,  // number of fields
  sizeof(interbotix_xs_msgs__srv__RegisterValues_Event),
  false,  // has_any_key_member_
  interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__RegisterValues_Event_message_member_array,  // message members
  interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__RegisterValues_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__RegisterValues_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__RegisterValues_Event_message_type_support_handle = {
  0,
  &interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__RegisterValues_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_interbotix_xs_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_xs_msgs, srv, RegisterValues_Event)() {
  interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__RegisterValues_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__RegisterValues_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_xs_msgs, srv, RegisterValues_Request)();
  interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__RegisterValues_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_xs_msgs, srv, RegisterValues_Response)();
  if (!interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__RegisterValues_Event_message_type_support_handle.typesupport_identifier) {
    interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__RegisterValues_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__RegisterValues_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t interbotix_xs_msgs__srv__detail__register_values__rosidl_typesupport_introspection_c__RegisterValues_service_type_support_handle = {
  ...
  &interbotix_xs_msgs__srv__RegisterValues_Request__rosidl_typesupport_introspection_c__RegisterValues_Request_message_type_support_handle,
  &interbotix_xs_msgs__srv__RegisterValues_Response__rosidl_typesupport_introspection_c__RegisterValues_Response_message_type_support_handle,
  &interbotix_xs_msgs__srv__RegisterValues_Event__rosidl_typesupport_introspection_c__RegisterValues_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_xs_msgs, srv, RegisterValues_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_xs_msgs, srv, RegisterValues_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_xs_msgs, srv, RegisterValues_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_interbotix_xs_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_xs_msgs, srv, RegisterValues)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_xs_msgs, srv, RegisterValues_Event)()->data;
  }
