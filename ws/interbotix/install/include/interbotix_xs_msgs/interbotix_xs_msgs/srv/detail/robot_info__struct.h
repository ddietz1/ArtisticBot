...
enum
{
  interbotix_xs_msgs__srv__RobotInfo_Event__request__MAX_SIZE = 1
};
// response
enum
{
  interbotix_xs_msgs__srv__RobotInfo_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/RobotInfo in the package interbotix_xs_msgs.
typedef struct interbotix_xs_msgs__srv__RobotInfo_Event
{
  service_msgs__msg__ServiceEventInfo info;
  interbotix_xs_msgs__srv__RobotInfo_Request__Sequence request;
  interbotix_xs_msgs__srv__RobotInfo_Response__Sequence response;
} interbotix_xs_msgs__srv__RobotInfo_Event;

// Struct for a sequence of interbotix_xs_msgs__srv__RobotInfo_Event.
typedef struct interbotix_xs_msgs__srv__RobotInfo_Event__Sequence
{
